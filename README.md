...
2. Refer to the documentation generated by Doxygen to learn about the available functions and methods.

3. Use the directory structure and CMake files to incorporate CPVector into your project and compile it for the desired platform.
